...
private:
  ...
  std::string mId;           // id of the beacon (e.g. majorr+minorr+uuid)
...
// majorr,minorr, UUID identifiers
...
public:
  ...
  void setmajorr(const unsigned int majorr);
  void setminorr(const unsigned int minorr);
