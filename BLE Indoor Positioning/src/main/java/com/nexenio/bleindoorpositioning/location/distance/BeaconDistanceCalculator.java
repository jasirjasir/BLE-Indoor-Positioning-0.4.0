...
public abstract class BeaconDistanceCalculator {
    ...
    public static final float PATH_LOSS_PARAMETER_GRACEVILLA=2.0f;
    private static float pathLossParameter = PATH_LOSS_PARAMETER_GRACEVILLA;
    ...
    public static float getCalibratedRssiAtOneMeter(float calibratedRssi, float calibratedDistance) {
        ...
        //System.out.println("calibratedRssiAtOneMeter="+calibratedRssiAtOneMeter);
    ...
    public static float calculateDistance(float rssi, float calibratedRssi, float pathLossParameter) {
       // calibratedRssi=-70;
         //System.out.println("rssi="+rssi+"   calibratedRssi="+calibratedRssi+"   pathLossParameter="+pathLossParameter);
